...
public class ClassificadosContratoNotaFiscalSaidaDAO {
	...
	public ClassificadosContratoNotaFiscalSaida inserirInterface(ClassificadosContratoNotaFiscalSaida model) throws TSApplicationException {

		TSDataBaseBrokerIf broker = TSDataBaseBrokerFactory.getDataBaseBrokerIf();

		broker.beginTransaction();

		model.setInterfaceId(broker.getSequenceNextValue("classificadoscontratonotafiscalsaida_id_seq"));

		broker.setPropertySQL("classificadoscontratonotafiscalsaidadao.inserirInterface", model.getInterfaceId(),
	...
	public List<ClassificadosContratoNotaFiscalSaida> pesquisarInterface(ClassificadosContratoNotaFiscalSaida model) {

		TSDataBaseBrokerIf broker = TSDataBaseBrokerFactory.getDataBaseBrokerIf();
		
		broker.setPropertySQL("classificadoscontratonotafiscalsaidadao.pesquisarInterface", model.getEmpresa().getId());
		
		return broker.getCollectionBean(ClassificadosContratoNotaFiscalSaida.class, "interfaceId", 
	...
	public void alterarInterface(ClassificadosContratoNotaFiscalSaida model) throws TSApplicationException {

		TSDataBaseBrokerIf broker = TSDataBaseBrokerFactory.getDataBaseBrokerIf();
		
		broker.setPropertySQL("classificadoscontratonotafiscalsaidadao.alterarInterface", model.getStatus().getId(), model.getMensagemErro(), model.getDataAtualizacao(), model.getDataImportacao(), model.getInterfaceId());
		
		broker.execute();
		
	}

	public void excluirInterface(ClassificadosContratoNotaFiscalSaida model) throws TSApplicationException {

		TSDataBaseBrokerIf broker = TSDataBaseBrokerFactory.getDataBaseBrokerIf();
		
		broker.setPropertySQL("classificadoscontratonotafiscalsaidadao.excluirInterface", model.getInterfaceId());
	...
	@SuppressWarnings("unchecked")
	public List<ClassificadosContratoNotaFiscalSaida> pesquisarPorAtrasadaInterface(ClassificadosContratoNotaFiscalSaida model) {

        TSDataBaseBrokerIf broker = TSDataBaseBrokerFactory.getDataBaseBrokerIf();
        
        broker.setPropertySQL("classificadoscontratonotafiscalsaidadao.pesquisarPorAtrasadaInterface", model.getStatus().getId());
	...
	public ClassificadosContratoNotaFiscalSaida obterIdExternoInterface(ClassificadosContratoNotaFiscalSaida model) {

		TSDataBaseBrokerIf broker = TSDataBaseBrokerFactory.getDataBaseBrokerIf();
		
		broker.setPropertySQL("classificadoscontratonotafiscalsaidadao.obterIdExternoInterface", model.getIdExterno(), model.getEmpresa().getId());
		
		return (ClassificadosContratoNotaFiscalSaida) broker.getObjectBean(ClassificadosContratoNotaFiscalSaida.class, "interfaceId");
	}	
}
