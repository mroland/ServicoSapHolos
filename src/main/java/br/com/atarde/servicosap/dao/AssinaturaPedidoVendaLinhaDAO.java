...
public class AssinaturaPedidoVendaLinhaDAO {
	...
	public AssinaturaNotaFiscalSaidaLinha inserirInterface(AssinaturaNotaFiscalSaidaLinha model, TSDataBaseBrokerIf broker) throws TSApplicationException {
        ...
        broker.setSQL("INSERT INTO ASSINATURAPEDIDOVENDA_LINHAS(ID, PEDIDOVENDA_ID, ITEM_ID, QUANTIDADE, VALOR_UNITARIO, VALOR, CODIGO_IMPOSTO_ID, CST_COFINS, CST_ICMS, CST_IPI, CST_PIS, CONTA_CONTABIL_ID, CFOP, CODIGO_BARRAS, UTILIZACAO_ID, VOLUME, FLAG_IMPOSTO, DEPOSITO_ID, UNIDADE_NEGOCIO_ID) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
