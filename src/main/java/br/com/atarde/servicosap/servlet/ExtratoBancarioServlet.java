 ...
 */
@WebServlet("/ExtratoBancarioServlet")
public class ExtratoBancarioServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExtratoBancarioServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(TSUtil.isEmpty(empresaId)){
			...
			if(TSUtil.isEmpty(empresa)){
				...
				new ExtratoBancarioBusiness().inserirSAP(empresa);
