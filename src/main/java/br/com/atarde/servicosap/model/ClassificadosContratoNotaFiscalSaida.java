...
@XmlRootElement
public class ClassificadosContratoNotaFiscalSaida extends NotaFiscalSaidaAB implements Serializable {
    ...
    private List<ClassificadosContratoNotaFiscalSaidaLinha> linhas;
    ...
    public ClassificadosContratoNotaFiscalSaida(Status status) {
        
        this.setStatus(status);
        
    }

    public ClassificadosContratoNotaFiscalSaida(Empresa empresa) {
		this.setEmpresa(empresa);
	}

	public ClassificadosContratoNotaFiscalSaida(String atributo, Long valor) {
	...
	public List<ClassificadosContratoNotaFiscalSaidaLinha> getLinhas() {
		return linhas;
	}

	public void setLinhas(List<ClassificadosContratoNotaFiscalSaidaLinha> linhas) {
		this.linhas = linhas;
	}
