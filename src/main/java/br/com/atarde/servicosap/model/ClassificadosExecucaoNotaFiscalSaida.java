...
@XmlRootElement
public class ClassificadosExecucaoNotaFiscalSaida extends NotaFiscalSaidaAB implements Serializable {
    ...
    public ClassificadosExecucaoNotaFiscalSaida() {
    }
    
    public ClassificadosExecucaoNotaFiscalSaida(Status status) {
        
        this.setStatus(status);
        
    }

    public ClassificadosExecucaoNotaFiscalSaida(Empresa empresa) {
		this.setEmpresa(empresa);
	}

	public ClassificadosExecucaoNotaFiscalSaida(String atributo, Long valor) {
