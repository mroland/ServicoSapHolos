...
public class TransferenciaEstoqueDAO {
	...
	public TransferenciaEstoque obterIdExterno(TransferenciaEstoque model) {
		...
		return (TransferenciaEstoque) broker.getObjectBean(TransferenciaEstoque.class, "id", "idExterno", "dataDocumento", "serial", "sequencia.id", "sequencia.sequenciaModelo.descricao");
